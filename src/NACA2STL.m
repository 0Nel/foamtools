...
NACA = [0 0 2 4];     % NACA 4-digit designation as a row vector;
...
pointfile_1 = fopen('pointfile_1.dat', 'w');
pointfile_2 = fopen('pointfile_2.dat', 'w');

% Write file
fprintf(pointfile_1, '# Naca Profile: %d %d %d %d\n', NACA(1), NACA(2), NACA(3), NACA(4));
fprintf(pointfile_1, '# Chord length: %e\n', c);
fprintf(pointfile_1, '# Angle of Attack: %e\n', alpha);
fprintf(pointfile_1, '### Coordinates ###\n')
fprintf(pointfile_1, '# X Y Z\n');

fprintf(pointfile_2, '# Naca Profile: %d %d %d %d\n', NACA(1), NACA(2), NACA(3), NACA(4));
fprintf(pointfile_2, '# Chord length: %e\n', c);
fprintf(pointfile_2, '# Angle of Attack: %e\n', alpha);
fprintf(pointfile_2, '### Coordinates ###\n')
fprintf(pointfile_2, '# X,Y,Z\n');


for i=1:length(X)
  % print out the coordinates
  fprintf(pointfile_1, '%e 0 %e\n', X(i), Z(i));
  fprintf(pointfile_2, '%e,0,%e\n', X(i), Z(i));
end
